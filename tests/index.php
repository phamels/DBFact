...
//    $response = $dbFact->LadresExport($sessionId, EXTRA_PASSWORD, 'ladres.L_Relnum = '. $response->CustomerNumber);
...
//    $response = $dbFact->relExport($sessionId, EXTRA_PASSWORD, 'R_Nummer = '. $response->CustomerNumber);
} catch (Exception $e) {
    var_dump($e);
}
